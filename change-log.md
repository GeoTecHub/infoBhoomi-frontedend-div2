...
09/06/25
### added new behavior to detect the deselection of a parcel
### change the active tab based on selected featureId
### extended the sidebar width based on selected feature